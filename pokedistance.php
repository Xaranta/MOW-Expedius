...
?>
    ...
    <div id = "banner-ad" style="position: relative; overflow: hidden; background-color: #0384BD;"><h1>BANNER AD GOES HERE</h1><h1>BANNER AD GOES HERE</h1>
        <h1>BANNER AD GOES HERE</h1>
    </div>
    <div id="map">map not loading</div>
    <div id = "banner-ad" style="position: relative; overflow: hidden; background-color: #0384BD;"><h1>MENU BUTTON GOES HERE</h1>
        <button type="button" style="background-color:transparent;"><img src="menubutton.png" style="width:50px;height:50px;background:transparent;"></button>
    </div>
